...
if cd $android_working_dir$foldername; then
    ...
    echo -e "\nCloning Tucana DT\n"
    git clone https://github.com/erikdrozina/android_device_xiaomi_tucana-oss -b arrow-11 device/xiaomi/tucana

    echo -e "\nCloning Common DT\n"
    git clone https://github.com/alibei/android_device_xiaomi_sm6150-common-oss device/xiaomi/sm6150-common
